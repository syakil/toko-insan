   ...
   <table class="table table-striped tabel-produk">
      <thead>
         <tr>
            <th>Kode Produk</th>
            <th>Nama Produk</th>
            <th>Harga Julan Member Insan</th>
            <th>Harga Julan Member Pabrik</th>
      ...
      <tbody>
         ...
         <tr>
            ...
            <th>Rp. {{ format_uang($data->harga_jual_member_insan) }}</th>
            <th>Rp. {{ format_uang($data->harga_jual_pabrik) }}</th>
