<div class="modal" id="list-hold" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
   ...
   <div class="modal-header">
      ...
      <h3 class="modal-title">Pilih Surat Jalan</h3>
   </div>
   ...
   <table class="table table-striped list-hold">
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
               <a href="{{route('retur_tukar_barang_detail.continued', $data->id_pembelian)}}" class="btn btn-primary"><i class="fa fa-check-circle"></i> Pilih</a>
               <a onclick= "deleteData({{$data->id_pembelian}})" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
            </td>
          </tr>
         @endforeach
      </tbody>
