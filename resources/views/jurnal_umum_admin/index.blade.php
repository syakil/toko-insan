...
<div class="row">
  <div class="col-xs-12">
    ...
    <div class="col-md-6 justify-content-center">
      <form action="{{ route('jurnal_umum_admin.create')}}" method="post">
      {{ csrf_field() }}
      <!-- kode Transaksi -->
      ...
      <table class="table table-striped" id="tables">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('jurnal_umum_admin.destroy',$p->id_transaksi)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a></td>
            ...
            <a href="{{ route('jurnal_umum_admin.approve')}}" class="btn btn-danger pull-right"><i class="fa fa-legal"> </i> Selesai</a>
            @endif
      </div>
