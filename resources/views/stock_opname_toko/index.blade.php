...
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            ...
            <a href="{{route('stock_opname_toko.export_excel')}}" type="button" class="btn btn-danger" >Download Contoh File</a>
            </div>  
            <!-- Modal -->
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('stock_opname_toko.import_excel')}}" enctype="multipart/form-data">
            ...
            <div class="box-footer">
                <form action="{{route('stock_opname_toko.proses')}}" method="post">
                    {{csrf_field()}}
...
$(function(){
   table = $('.tabel-stock').DataTable({
     ...
     "ajax" : {
       "url" : "{{ route('stock_opname_toko.data') }}",
       "type" : "GET"
     }
   });
