   ...
   <table class="table table-striped tabel-member-awal">
      ...
      <tbody>
         ...
         <tr>
            ...
            <th><a  onclick="selectMember({{ $data->kode_member }})" data-id="{{ $data->kode_member }}" data-nama="{{$data->nama}}" class="btn btn-primary pilih-member"><i class="fa fa-check-circle"></i> Pilih</a></th>
