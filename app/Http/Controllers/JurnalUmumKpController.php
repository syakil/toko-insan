...
class JurnalUmumKpController extends Controller
{
    public function index(){
        ...
        return view('jurnal_umum_kp.index',['kode_transaksi'=>$kode_transaksi,'list_jurnal'=>$list_jurnal,'nomer'=>$nomer,'debet'=>$debet,'kredit'=>$kredit,'rekening'=>$rekening]);
    }
    ...
    public function create(Request $request){
        ...
        if ($request->transaksi == "debit") {
            ...
            $debet_count = DB::table('tabel_transaksi')
                ...
                // dd($debet_count);
            if ($debet_count >= 1) {            
                return Redirect::route('jurnal_umum_kp.index')->with(['error' => 'Transaksi Debit Hanya 1x']);
            }
            ...
            return Redirect::route('jurnal_umum_kp.index');
        }
