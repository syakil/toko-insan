...
class KoreksiPenjualanCreditPabrikController extends Controller{
    ...
    public function index(){
        ...
        if(!empty(session('idpenjualan'))){
            ...
            if($status=='active'){
                ...
                return view('koreksi_penjualan_pabrik.index', compact('produk', 'member', 'setting', 'idpenjualan'));
            
            }else{
        
                return back()->with(['error' =>'Maaf Status Member blokir']);
    ...
    public function simpan(Request $request){
        ...
        return Redirect::route('koreksi_penjualan_pabrik.cetak');
    ...
    public function printNota(){
        ...
        return view('koreksi_penjualan_pabrik.selesai', compact('setting'));
    }
    ...
    public function notaPDF(){
        ...
        $pdf = PDF::loadView('koreksi_penjualan_pabrik.notapdf', compact('musawamah','detail','toko', 'penjualan', 'setting', 'no'));
