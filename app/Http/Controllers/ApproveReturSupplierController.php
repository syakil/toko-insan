...
class ApproveReturSupplierController extends Controller{
    
    public function index(){

        return view('approve_retur_supplier.index');
    ...
    public function listData(){
        ...
        $retur = Kirim::leftJoin('supplier', 'supplier.id_supplier', '=', 'kirim_barang.id_supplier')
                        ...
                        ->where('kirim_barang.status','approve')
                        ->get();
    ...
    public function approve($id){
        ...
        try {
            ...
            DB::beginTransaction();
                ...
                KirimDetailTemporary::where('id_pembelian',$id_pembelian)->delete();
